...
const r = (key, label, hint, def) => ({ key, label, hint, ...def });
...
export const PERM_SECTIONS = [
  {
    ...
    rows: [
      ...
      r('player_tang',    'เปลี่ยนทาง (บันไดเสียง)',       'ทางใน ทางเพียงออล่าง ฯลฯ', MEMBERS),
  ...
  },
  {
    ...
    rows: [
      ...
      r('staff_beat',    'โน้ตสากล: จังหวะตกแบบสากล',      null, MEMBERS),
    ],
  },
  {
    ...
    rows: [
      ...
      r('board_tang',     'เปลี่ยนทางบนกระดาน',         null, MEMBERS),
      r('board_notens',   'เลือกระบบที่จด (ปี่พาทย์ / เครื่องสาย)', null, MEMBERS),
      r('board_tangview', 'เลือกวิธีเปลี่ยนทาง (ตรึงโน้ต / ย้ายโน้ตจริง)', null, MEMBERS),
