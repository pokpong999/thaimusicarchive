...
export const TOKEN_SLUG = {
  'เท่ง': 'theng', 'ติง': 'ting', 'ทิง': 'thing',
  'พรึม': 'phrum', 'ตุ๊บ': 'tup', 'ทั่ม': 'tham',
  'ป๊ะ': 'pa', 'จ๊ะ': 'ja', 'โจ๊ะ': 'jo', 'ฉะ': 'cha',
  'ฉิ่ง': 'ching', 'ฉับ': 'chap',
};
...
export const RECOMMENDED = {
  taphon:       ['theng', 'phrum', 'pa', 'tham'],
  klongkhaek:   ['ting', 'tham', 'ja', 'cha'],
  klongsongna:  ['thing', 'tup', 'pa', 'cha'],
  thonrammana:  ['thing', 'tham', 'jo', 'cha'],
  ching:        ['ching', 'chap'],
};
