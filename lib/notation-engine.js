...
export const ENGINE_VERSION = '27 ส.ค. 69 · r13';
...
export class NotationEngine {
  ...
  clearCurCell() {
    ...
    // ★ เครื่องหมายกรอ/ประคบผูกกับ "ช่อง" ไม่ใช่แนวใดแนวหนึ่ง
    //   เดิมลบโน้ตจนช่องว่างแล้ว ตัว 'ก' ยังค้างอยู่ เอาออกไม่ได้เลยถ้าไม่รู้ว่าต้องกด ~
    //   ตอนนี้ช่องว่างเมื่อไหร่ เครื่องหมายหายตามทันที (Pk 28 ส.ค. 69)
