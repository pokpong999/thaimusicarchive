...
export class NotationEngine {
  constructor(root, opts = {}) {
    ...
    this.S = { ta, rap, system: SYSTEMS[opts.system] ? opts.system : (opts.twoHands ? 'hands2' : 'melody1'), sound: true,
      reg: 0, sabatArm: false, bpm: opts.bpm || 120, chingOn: false,
  ...
  getState() { const S = this.S; return { base: S.base, lineHong: S.lineHong, ta: S.ta, rap: S.rap, system: S.system, lines: lineCount(S.system), twoHands: S.twoHands, ensemble: S.ensemble, tuning: S.tuning, tang: S.tang, tangHome: S.tangHome, notEns: S.notEns, tangView: S.tangView, level: S.level, chingMode: S.chingMode }; }
