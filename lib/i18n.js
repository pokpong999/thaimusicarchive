...
const DICT = {
  th: {
    ...
    nav_admin: 'ผู้ดูแล', nav_profile: 'โปรไฟล์', nav_side: '☰ เมนูข้าง', nav_top: '⇧ ใช้แถบเมนูด้านบน',
    ...
    home_db_cta: 'เข้าชมฐานข้อมูลเพลง →',
  ...
  en: {
    ...
    nav_admin: 'Admin', nav_profile: 'Profile', nav_side: '☰ Side menu', nav_top: '⇧ Use top bar',
    ...
    home_db_cta: 'Browse the database →',
