...
const DICT = {
  th: {
    ...
    nav_add: 'TH Notation+', nav_mine: 'ของฉัน', nav_diary: '📔 ไดอารี่', nav_login: 'เข้าสู่ระบบ', nav_logout: 'ออกจากระบบ',
  ...
  en: {
    ...
    nav_add: 'TH Notation+', nav_mine: 'My Page', nav_diary: '📔 Diary', nav_login: 'Sign in', nav_logout: 'Sign out',
